...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* UI Layers */}
      <div className="relative z-20 min-h-[100svh] w-full flex flex-col items-center justify-between py-8 md:py-16 px-4 md:px-10 pointer-events-none overflow-hidden">
